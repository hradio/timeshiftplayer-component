 ...
 */
public class TimeshiftPlayerPcmAuSdk16 extends TimeshiftPlayerAacAuSdk16 implements TimeshiftPlayerPcmAu, Serializable, RadioServiceAudiodataListener, TextualMetadataListener, VisualMetadataListener {

	private static final long serialVersionUID = -8535166233779545394L;

	private static final String TAG = "TimeshiftPlayerPcmAu16";

	private PcmResampler mPcmResampler = null;

	TimeshiftPlayerPcmAuSdk16(Context context) {
		super(context);
		if(DEBUG) Log.d(TAG, "Creating PcmAuPlayer for SDK 16");
	}
	...
	private void configureEncoder() throws IOException {
		...
		mEncMediaFormat.setInteger(MediaFormat.KEY_AAC_PROFILE, MediaCodecInfo.CodecProfileLevel.AACObjectLC);
